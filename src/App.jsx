...
const FONTS = `
@import url('https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:wght@400;600;800&family=IBM+Plex+Sans:wght@400;500;600&family=IBM+Plex+Mono:wght@500&family=Caveat:wght@600&display=swap');
`;
        ...
        quiz: [
          ...
          },
          {
            ...
            options: [
              ...
              "Distance around a shape's edge",
              'Volume of a box',
              'Weight of an object',
            ],
            correct: 1,
        ...
        quiz: [
          ...
          },
          {
            ...
            options: [
              ...
              'A letter to a government office',
              'A legal complaint',
            ],
            correct: 1,
          },
        ...
        quiz: [
          ...
          },
          {
            ...
            options: [
              ...
              'Bending as it passes between materials',
              'Disappearing',
              'Turning into sound',
            ],
            correct: 1,
        ...
        quiz: [
          {
            ...
            options: [
              ...
              'Realism, proportion, and anatomy',
              'Random splatters',
              'Digital tools',
            ],
            correct: 1,
    ...
    chapters: [
      {
        ...
        reference:
          'Parable of the Sower — Matthew 13:1-9; Parable of the Good Samaritan — Luke 10:25-37',
        quiz: [
          {
      ...
      },
      {
        ...
        reference:
          'Exodus 2-14 (birth and the Exodus); Exodus 20 (the Ten Commandments)',
        quiz: [
          {
      ...
      },
      {
        ...
        reference:
          'The Gospels — Matthew, Mark, Luke, John; Acts of the Apostles; Revelation (final book)',
        quiz: [
          {
      ...
      },
      {
        ...
        reference:
          "The Lord's Prayer — Matthew 6:9-13; on persistence in prayer — Luke 18:1-8",
        quiz: [
          {
          ...
          <>
            ...
            >
              <svg width="16" height="16" viewBox="0 0 48 48">
                <path
                  fill="#FFC107"
                  d="M43.6 20.5H42V20H24v8h11.3C33.7 32.9 29.3 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.8 1.1 8 3l6-6C34.5 5.5 29.5 3.5 24 3.5 12.7 3.5 3.5 12.7 3.5 24S12.7 44.5 24 44.5 44.5 35.3 44.5 24c0-1.2-.1-2.4-.9-3.5z"
                />
                <path
                  fill="#FF3D00"
                  d="M6.3 14.7l6.6 4.8C14.6 16 19 13.5 24 13.5c3.1 0 5.8 1.1 8 3l6-6C34.5 6.5 29.5 4.5 24 4.5c-7.6 0-14.1 4.3-17.4 10.6z"
                />
                <path
                  fill="#4CAF50"
                  d="M24 44.5c5.4 0 10.2-1.8 13.9-5l-6.4-5.4c-2 1.4-4.6 2.4-7.5 2.4-5.3 0-9.7-3.1-11.4-7.5l-6.5 5C9.8 40.1 16.4 44.5 24 44.5z"
                />
                <path
                  fill="#1976D2"
                  d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.3 4.2-4.2 5.6l6.4 5.4C40.9 36.5 44 30.9 44 24c0-1.2-.1-2.4-.4-3.5z"
                />
              </svg>
              {status === 'sending'
                ? 'Opening Google…'
            ...
            <div
              className="flex items-center gap-2 mb-3 px-3 py-2.5 rounded-md"
              style={{ backgroundColor: COLORS.paperDark }}
            >
  ...
  return (
    <div style={{ backgroundColor: COLORS.paper }}>
      ...
      >
        ...
        <p
          className="max-w-xl mt-6 text-base md:text-lg"
        ...
        <div
          className="flex flex-wrap gap-x-8 gap-y-2 mt-10 text-sm"
      ...
      <section className="px-6 md:px-10 py-16 max-w-4xl">
        ...
        <p className="max-w-2xl leading-relaxed" style={{ color: COLORS.ink }}>
          ...
          called the <strong>testing effect</strong>: actively quizzing yourself
          on material helps it stick far better than re-reading notes alone.
          That's why every lesson here ends with a quiz instead of just a "next"
          button.
        </p>
        <div
...
function SubjectView({ subject, onBack, onSelectLesson, progress }) {
  ...
  return (
    <div>
      <section
        className="px-6 md:px-10 pt-10 pb-14"
  ...
  return (
    ...
    >
      ...
      {view === 'landing' ? (
        ...
        <p
          className="px-6 md:px-10 py-10 text-sm"
